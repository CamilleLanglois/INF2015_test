...
public class Application {
    ...
    public static Boolean jsonToEmployeList(JSONObject jsonObject){
        ...
        try{
            ...
            Double hourly_rate_min = jsonObject.getDouble("taux_horaire_min"); 
            Double hourly_rate_max = jsonObject.getDouble("taux_horaire_max");
            ...
            for (int i = 0; i<employeArray.size(); i++){
                ...
                Employe e = new Employe(employe.getString("nom"), department_type, hourly_rate_min, hourly_rate_max);
